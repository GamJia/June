...
public class Dialogue_0 : MonoBehaviour
{
    ...
    public void Script_0()
    {
        ...
        dialogTexts.Add(new DialogData("/size:init//emote:Embrassed/집 오다가 나도 모르게 차에 치였나?", "June"));
        ...
        dialogTexts.Add(new DialogData("/size:init//emote:Molu/제일 만만해보이기 때문이다", "God"));
